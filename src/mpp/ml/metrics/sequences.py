...
class Sequence_comparator:
    ...
    def elementwise_accuracy(self, a, b, mask):
        ...
        for i in range(a.size(0)):
            ...
            if valid_positions > 0:
                ...
                acc = torch.tensor(0.0, device=a.device)  # optional: NaN if desired
    ...
    def compare(self, a, b):
        ...
        Args:
            a, b: Tensors of shape (batch_size, seq_len)

        Returns:
            dict with local and global metrics
        """
        ...
        metrics = {
            "global_elementwise_accuracy": self.global_elementwise_accuracy(a, b, mask_b),
